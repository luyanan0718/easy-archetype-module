...
import io.github.luyanan0718.easy.archetype.data.file.FileProperties;
import io.github.luyanan0718.easy.archetype.data.file.FileTemplate;
import io.github.luyanan0718.easy.archetype.data.file.IFileService;
import io.github.luyanan0718.easy.archetype.data.file.server.storagestrategy.FtpFileStorageStrategy;
...
public class FileServiceAutoConfiguration {
	 ...
	 * @return io.github.luyanan0718.easy.archetype.framework.data.file.IFileService
	 * @since 2021/2/25
	 */
	@Bean
	 ...
	 * @return io.github.luyanan0718.easy.archetype.framework.data.file.server.IFileStorageStrategy
	 * @since 2021/2/25
	 */
	@Bean
	 ...
	 * 文件服务端点
	 *
	 * @return io.github.luyanan0718.easy.archetype.framework.data.file.server.FileServiceEndpoint
	 * @since 2021/2/26
	 */
