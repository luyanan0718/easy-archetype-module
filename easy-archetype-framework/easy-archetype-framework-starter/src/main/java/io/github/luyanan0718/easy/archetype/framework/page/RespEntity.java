package io.github.luyanan0718.easy.archetype.framework.page;
...
public class RespEntity<T> implements Serializable {
	 ...
	 *
	 * @param data 返回的数据
	 * @return io.github.luyanan0718.easy.archetype.framework.core.RespEntity<T>
	 * @since 2021/1/24
	 */
	 ...
	 * @return io.github.luyanan0718.easy.archetype.framework.core.page.RespEntity
	 * @since 2021/2/28
	 */
	 ...
	 * @param msg    异常消息
	 * @param status 异常编码
	 * @return io.github.luyanan0718.easy.archetype.framework.core.page.RespEntity<T>
	 * @since 2021/2/28
	 */
